...
bharat = Customer(1,'Bharat','bharat@gmail.com',9876543210,21,50000,750)
bharat.display_customer()
print("Loan Eligibility:",bharat.check_eligibility())


deepak = Customer(1,'Deepak','deepak@gmail.com',9876543210,21,60000,600)
deepak.display_customer()
print("Loan Eligibility:",deepak.check_eligibility())
